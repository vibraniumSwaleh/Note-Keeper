...
import com.example.gho5t.notekeeper.NoteKeeperDatabaseContract.CourseInfoEntry;
import com.example.gho5t.notekeeper.NoteKeeperDatabaseContract.NoteInfoEntry;
...
//            ourInstance.initializeExampleNotes();
    ...
    private static void loadNotesFromDatabase(Cursor cursor) {
        ...
        int noteIdPos = cursor.getColumnIndex(NoteInfoEntry.COLUMN_COURSE_ID);
        ...
        while (cursor.moveToNext()){
            ...
            String courseId = cursor.getString(noteIdPos);
